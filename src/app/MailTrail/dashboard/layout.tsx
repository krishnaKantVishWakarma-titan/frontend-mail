            ...
            <div className="hidden sm:block">
              ...
              <div className="relative min-w-72 md:min-w-80">
                ...
                <input
                  ...
                  id="icon"
                  name="icon"
                  className="py-2 px-4 ps-11 block border w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                  placeholder="Search"
                />
              </div>
            </div>
